(function (e) {
    ...
    e.module("ui.materialize",
        ["ui.materialize.ngModel",
            ...
            "ui.materialize.scrollspy",
            "ui.materialize.parallax",
            "ui.materialize.modal",
            "ui.materialize.tooltipped",
            "ui.materialize.slider",
            "ui.materialize.materialboxed",
            "ui.materialize.scrollFire",
            "ui.materialize.nouislider",
            "ui.materialize.input_clock",
            "ui.materialize.carousel"]);
    e.module("ui.materialize.scrollFire", [])
        .directive("scrollFire", ["$compile", "$timeout", function (i, n) {
            return {
                restrict: "A",
                ...
                link: function (i, n, a) {
                    ...
                    var l = t(function () {
                        ...
                        if (e > t + o) { r = true; i.scrollFire({}); s() }
                    }, 100); function s() { $(window).off("scroll resize blur focus", l) } $(window).on("scroll resize blur focus", l); l(); i.$on("$destroy", s)
                }
            }
        }]);
    function t(e, i) {
        ...
        var s = function () {
            ...
            if (u <= 0 || u > i) {
                ...
                o = e.apply(n, a);
                if (!t) n = a = null
            } else if (!t) { t = setTimeout(l, u) } return o
        }; s.cancel = function () { clearTimeout(t); r = 0; t = n = a = null }; return s
    }
    e.module("ui.materialize.ngModel", [])
        .directive("ngModel", ["$timeout", function (e) {
            return {
                    ...
                    function (t, n, a) {
                        t.$watch(a.ngModel, function (t, a) {
                            e(function () {
                                ...
                                } if (t) { n.trigger("change") } else if (n.attr("placeholder") === i) { if (!n.is(":focus")) n.trigger("blur") }
                            })
                        })
                    }
            }
        }]);
    e.module("ui.materialize.slider", [])
        .directive("slider", ["$timeout", function (i) {
            return {
                restrict: "A", scope: {
                    height: "=",
                    transition: "=",
                    ...
                    n.addClass("slider"); i(function () {
                        n.slider({
                            height: e.isDefined(t.height) ?
                                t.height : 400,
        ...
        }]); e.module("ui.materialize.carousel", [])
